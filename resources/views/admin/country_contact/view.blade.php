      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-lg-5" style="text-align:end;">
            <a style="color: #000;" href="{{url('create_country_contact')}}"><i data-feather="plus-square"></i></a>
          </div>
        </div>
      </div>
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="dataTableExample" class="table table-striped text-center">
            ...
            <tr class="{{$country->status == 1?'bg-secondary':''}}">
              ...
              <td>
                <a href="{{url('active_country')}}/{{$country->id}}" class="btn @php echo $country->status == 0?'bg-maroon':'bg-blue'@endphp">
                  @php
              ...
              <td>
                <a style="color: #000;" href="{{url('edit_country')}}/{{$country->id}}"><i data-feather="edit"></i></a>
                <a style="color: #000;" href="{{url('delete_country')}}/{{$country->id}}"><i data-feather="trash"></i></a>
              </td>
            </tr>
            @php $i++; @endphp
            @endforeach
