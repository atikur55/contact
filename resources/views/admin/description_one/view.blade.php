      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-lg-5" style="text-align:end;">
            <a style="color: #000;" href="{{url('create_description_one')}}"><i data-feather="plus-square"></i></a>
          </div>
        </div>
      </div>
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="dataTableExample" class="table table-striped text-center">
            ...
            <tr class="{{$description->status == 1?'bg-secondary':''}}">
              ...
              <td>
                <img src="{{asset('uploads/description_one/')}}/{{$description->image}}" width="80px" alt="">
              </td>
              <td>
                <a href="{{url('active_description_one')}}/{{$description->id}}" class="btn @php echo $description->status == 0?'bg-maroon':'bg-blue'@endphp">
                  @php
              ...
              <td>
                <a style="color: #000;" href="{{url('edit_description_one')}}/{{$description->id}}"><i data-feather="edit"></i></a>
                <a style="color: #000;" href="{{url('delete_description_one')}}/{{$description->id}}"><i data-feather="trash"></i></a>
              </td>
            </tr>
            @php $i++; @endphp
            @endforeach
