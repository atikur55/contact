  ...
  <div class="col-lg-12 stretch-card">
    <div class="card">
      ...
      <div class="card-header">
        <div class="row">
          <div class="col-lg-7">
            Edit Description Two 
          </div>
          <div class="col-lg-5" style="text-align:end;">
            <a style="color: #000;" href="{{url('view_description_two')}}"><i data-feather="arrow-left-circle"></i></a>
          </div>
        </div>
      </div>
            <div class="card-body">
                <div class="col-lg-7 m-auto">
                  <form action="{{url('edit_description_two_post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-2">
                      <img src="{{asset('uploads/description_two/')}}/{{$description->image}}" width="200px" alt="">
                    </div>
                    <div class="form-group">
