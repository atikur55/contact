          ...
          <div class="col-lg-5" style="text-align:end;">
            ...
            <div class="card-body">
                <div class="col-lg-7 m-auto">
                  <form action="{{url('lander_banner_post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                      <label for="exampleInputUsername1">Service Banner Title</label>
                      <input type="text" name="title" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Service Banner Title">
                      @error('title')
