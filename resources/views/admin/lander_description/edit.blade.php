          ...
          <div class="col-lg-5" style="text-align:end;">
            ...
            <div class="card-body">
                <div class="col-lg-7 m-auto">
                  <form action="{{url('edit_lander_description_post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <!-- <input type="text" name="paragraph" class="form-control" id="exampleInputUsername1" autocomplete="off" value="{{$banner->paragraph}}"> -->
                      <textarea name="paragraph" id="" cols="5" rows="5" class="form-control">{{$banner->paragraph}}</textarea>
                      @error('paragraph')
                      <div class="alert alert-danger">
                        <strong>{{$message}}</strong>
                      </div>
                    ...
                    <div class="my-2">
                      <img src="{{asset('uploads/lander_description/')}}/{{$banner->image}}" width="200px;" alt="">
                    </div>
                    <div class="form-group">
