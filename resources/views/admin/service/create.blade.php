          ...
          <div class="col-lg-5" style="text-align:end;">
            ...
            <div class="card-body">
                <div class="col-lg-7 m-auto">
                  <form action="{{url('service_post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="service_name" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Service Name">
                      @error('service_name')
                      <div class="alert alert-danger">
                        <strong>{{$message}}</strong>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="image_title" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Image Title">
                      @error('image_title')
                      <div class="alert alert-danger">
                        <strong>{{$message}}</strong>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="image_sub_title" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Image Sub Title">
