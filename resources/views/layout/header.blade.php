  ...
  <div class="navbar-content">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown nav-notifications">
        ...
        <div class="dropdown-menu" aria-labelledby="notificationDropdown">
          <div class="dropdown-header d-flex align-items-center justify-content-between">
            <p class="mb-0 font-weight-medium">Your Item</p>
            <!-- <a href="javascript:;" class="text-muted">Clear all</a> -->
          </div>
          <div class="dropdown-body">
            <a href="javascript:;" class="dropdown-item">
              <div class="">
                <!-- <i data-feather="user-plus"></i> -->
                <img width="80px" src="{{asset('assets/images/1.jpg')}}" alt="...">
              </div>
              <div class="content">
                <p>Pizza</p>
                <p class="sub-text text-muted">Price : <span>250</span></p>
                <p class="sub-text text-muted">Quantity : <span>2</span></p>
              </div>
            </a>
            <a href="javascript:;" class="dropdown-item">
              <div class="">
          ...
          <div class="dropdown-footer d-flex align-items-center justify-content-center">
            <!-- ======  Front Cart Page ======  -->
            <a href="{{url('frontcart')}}">View all</a>
          </div>
        </div>
      </li>
